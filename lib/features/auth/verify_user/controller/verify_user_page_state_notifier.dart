...
final verifyUserPageStateNotifierProvider = StateNotifierProvider<VerifyUserPageStateNotifier, VerifyUserPageState>(
    (Ref ref) => VerifyUserPageStateNotifier(ref.read(verifyUserRepositoryProvider)));

class VerifyUserPageStateNotifier extends StateNotifier<VerifyUserPageState> {
  VerifyUserPageStateNotifier(this._verifyUserRepository) : super(const VerifyUserPageState.initial());
