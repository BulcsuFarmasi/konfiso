...
void main() {
  group('BookHomePage', () {
    ...
    testWidgets('should contain the books text', (WidgetTester widgetTester) async {
      await widgetTester.pumpWidget(createWidgetUnderTest());

      expect(find.text('Books'), findsOneWidget);
    });

    testWidgets('should contain 3 book home menu item', (WidgetTester widgetTester) async {
      await widgetTester.pumpWidget(createWidgetUnderTest());
