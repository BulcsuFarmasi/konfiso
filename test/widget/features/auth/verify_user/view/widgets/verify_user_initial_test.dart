...
void main() {
  group('VerifyUserInitial', () {
    ...
    testWidgets('should contain email text', (WidgetTester widgetTester) async {
      ...
      expect(find.text('We\'ve sent an email to verify your email address'),
          findsOneWidget);
    });
    ...
    testWidgets('should contain click text', (WidgetTester widgetTester) async {
      ...
      expect(
          find.text('Please click on the link in the email, then return here'),
          findsOneWidget);
    });

    testWidgets('should contain circular progress indicator',
