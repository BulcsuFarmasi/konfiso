...
//
//
// // class MockLoadingPageStateNotifier extends  Mock implements LoadingPageStateNotifier, StateNotifier {
// //   MockLoadingPageStateNotifier({LoadingPageState initialState = const LoadingPageState()}) : super(initialState);
// // }
//
void main() {
//   group('LoadingPage', () {
